...
QUnit.module("user functionalites", () => {
    QUnit.test("registration", async (assert) => {
        ...
        assert.equal(json['email'], user.email, "expect mail");
        ...
        assert.equal(json['password'], user.password, "expect password");
...
QUnit.module("games functionalities", () => {
    ...
    QUnit.test("create game", async (assert) => {
        ...
        game.summary = `Short random summary of ${game.title}`;
    ...
    QUnit.test("edit game", async (assert) => {
        ...
        game.summary = `Edited short summary of ${game.title}`;
